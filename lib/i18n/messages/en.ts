...
export const en = {
  ...
  "nav.temples": "Temples",
  "nav.templesFestivals": "Temples & Festivals",
  "nav.stories": "Village Stories",
  "nav.familyTrees": "Village Families",
  "nav.adapaduchulu": "Adapaduchulu",
  "nav.careers": "Careers",
  "nav.more": "More",
  "nav.kids": "Kids",
  "nav.english": "English",
  ...
  "home.hero.pillars": "Our Village. Our Heritage. Our Home.",
  "home.hero.support":
  ...
  "home.ourTemples": "Temples of Reddivaripalli",
  "home.ourPeople": "Our People",
  "home.villageStories": "Village Stories & Memories",
  "home.viewStories": "Read Stories",
  "home.viewTemples": "Temples & Festivals",
  "home.contactLocation": "Visit Reddivaripalli",
  "footer.preserve": "Preserving Our Village for Future Generations",
  "people.title": "Our People",
  "people.elders": "Our Elders",
  "people.families": "Our Families",
  "people.professionals": "Professionals",
  "people.notable": "Notable People",
  "people.contributors": "Our Village Contributors",
  "people.birthdays": "Birthdays",
  "gallery.filter.village": "Village",
  "gallery.filter.temples": "Temples",
  "gallery.filter.festivals": "Festivals",
  "gallery.filter.people": "People",
  "gallery.filter.old": "Old Photos",
  "gallery.filter.life": "Village Life",
  "gallery.filter.development": "Development",
  "gallery.filter.nature": "Nature",
  "dev.status.completed": "Completed",
  "dev.status.inProgress": "In Progress",
  "dev.status.planned": "Planned",
  ...
  "home.history.eyebrow": "Village record",
  "home.history.title": "History of Reddivaripalli",
  "home.history.lede":
    "Founded around 1850 as Kondareddigaripalli by Sri G. Konda Reddy. The written village record is kept on Our Village. Stories told by families live separately, under Village Stories.",
  "home.readHistory": "Read the history",
  "home.community.lede":
  ...
  // People counts. Interpolated from lib/people-stats.ts -- never a literal,
  // so English and Telugu always report the same derived figure.
  "settings-title": "Settings",
  "settings-lede": "Choose how this site looks and reads on this device. Your choices are saved here only.",
  "language": "Language",
  "language-lede": "Read the site in English or Telugu. The same records are shown either way.",
  "language-en": "English",
  "language-te": "తెలుగు",
  "email-us": "Email us",
  ...
  "edit-mode": "Edit mode",
  "editing": "Editing",
  "enter-edit": "Turn on edit mode",
  "exit-edit": "Turn off edit mode",
  "install-app": "Install this site as an app",
  "people.sections": "People sections",
  "people.eldersHeading": "Elders & Notable People",
  "people.eldersEyebrow": "Respected across generations",
  "people.contributorsHeading": "Village Contributors",
  "people.contributorsEyebrow": "Service to the village",
  "people.workOfVillage": "Work of the village",
  "people.directory": "Village directory",
  "people.birthdaysEyebrow": "Celebrated among us",
  "people.birthdayPhotos": "Birthday photographs",
  "people.noBirthdays": "No public birthdays have been shared yet.",
  "directory.title": "Village Directory",
  "directory.eyebrow": "Village services",
  "directory.loading": "Loading directory…",
  "directory.noMatches": "No directory matches for this search.",
  "directory.searchLabel": "Search directory",
  "directory.searchPlaceholder": "Search by name, designation, profession…",
  "directory.category": "Category",
  "directory.photoSoon": "Photo Coming Soon",
  "dev.title": "Village works",
  "dev.eyebrow": "Development",
  "dev.filterStatus": "Filter by status",
  "dev.noMatch": "No developments match this filter.",
  "dev.stage": "Project stage",
  "dev.currentStage": "Current stage ·",
  "dev.updates": "Updates",
  "stories.title": "Village Stories & Memories",
  "stories.eyebrow": "Community memory",
  "stories.forNext": "For the next generation",
  "stories.oldPhotos": "Old photographs",
  "stories.picturesWithStory": "Pictures with a story",
  "stories.heritageLede": "Heritage photographs kept with the words that belong to them.",
  "stories.openGallery": "Open the gallery",
  "stories.fromElders": "Stories from elders",
  "stories.remembered": "Remembered together",
  "stories.notOfficial": "Stories, not the official record",
  "stories.readRecord": "Read the village record",
  "stories.traditional": "Traditional practices",
  "stories.waysOfVillage": "Ways of the village",
  "gallery.title": "Gallery",
  "gallery.photographs": "Photographs",
  "gallery.allFestivals": "All festivals",
  "gallery.allYears": "All years",
  "gallery.category": "Gallery category",
  "gallery.mediaType": "Media type",
  "gallery.chooseYear": "Choose a year to browse photos and videos.",
  "gallery.noMedia": "No media in this view yet.",
  "gallery.noPhotos": "No photographs in this view yet.",
  "gallery.openAlbums": "Open album pages",
  "gallery.locked": "Locked",
  "gallery.devPhotos": "Development photographs will appear here as projects are documented.",
  "events.title": "Events",
  "events.andBirthdays": "Events and birthdays",
  "events.celebrate": "Celebrate",
  "events.birthdays": "Birthdays",
  "events.birthdayWishes": "Birthday wishes",
  "events.openBirthdayGallery": "Open birthday gallery",
  "events.upcoming": "Upcoming events",
  "events.past": "Past events",
  "events.nextUp": "Next up",
  "events.none": "No upcoming events on the calendar yet.",
  "events.viewGallery": "View gallery",
  "events.archive": "Archive",
  "events.gallery": "Gallery",
  "events.villageEvents": "Village events",
  "events.noneToday": "No village events listed for this day.",
  "events.noBirthdaysToday": "No birthdays on file for this day.",
  "events.panchangUnavailable": "Panchangam unavailable for this date.",
  "events.previous": "Previous",
  "events.next": "Next",
  "events.villageUpdates": "Village Updates",
  "events.notices": "Notices",
  "events.announcementsLede": "Announcements from the Gram Panchayat and RVP Youth.",
  "sugg.title": "Suggestions",
  "sugg.eyebrow": "Community voice",
  "sugg.shared": "Shared suggestions",
  "sugg.none": "No suggestions yet.",
  "sugg.loading": "Loading suggestions…",
  "sugg.submit": "Submit a suggestion",
  "sugg.submitBtn": "Submit suggestion",
  "sugg.name": "Name",
  "sugg.mobile": "Mobile",
  "sugg.subject": "Subject",
  "sugg.body": "Suggestion",
  "sugg.category": "Category",
  "sugg.adminReview": "Admin review",
  "sugg.adminLede": "Review and update status for community suggestions.",
  "members.totalMembers": "Total Members",
  "members.communityStats": "Community statistics",
  "members.legacyCircle": "Legacy Circle",
  "members.coreMembers": "Core Members",
  "members.nextGeneration": "Next Generation",
  "members.searchLabel": "Search members",
  "members.searchPlaceholder": "Search by name or designation…",
  "members.allCategories": "All categories",
  "members.allProfessions": "All professions",
  "members.category": "Category",
  "members.profession": "Profession",
  "members.order": "Order",
  "members.alphabetical": "Alphabetical",
  "members.byCategory": "By category",
  "members.noMatch": "No members match your search or filters.",
  "members.viewProfile": "View Profile",
  "members.closeProfile": "Close profile",
  "members.achievements": "Achievements",
  "members.photo": "Photo",
  "members.photoSoon": "Photo Coming Soon",
  "members.todaysBirthday": "Today's Birthday",
  "members.inLovingMemory": "In Loving Memory",
  "members.foreverRemembered": "Forever Remembered",
  "fam.villageFamilies": "Village Families",
  "fam.ourPeople": "Our People",
  "fam.search": "Search",
  "fam.searchMembers": "Search family members",
  "fam.searchPlaceholder": "Search family members...",
  "fam.viewFamily": "View Family",
  "home.browseYears": "Browse the years",
  "home.festivalStory": "Festival Story",
  "home.frames": "Frames",
  "home.hoverHint": "Hover an image to start its slideshow. Click to open the album.",
  "home.moveOverMemory": "Move over a memory",
  "home.seasons": "Seasons",
  "home.story": "Story",
  "home.whyChapter": "Why this chapter matters",
  "home.years": "Years",
  "home.everyMoment": "Every moment, kept alive",
  "home.festivalsJourneys": "Festivals and journeys — doorways into the archive.",
  "home.framesFromHome": "Frames from home",
  "home.fullscreen": "Fullscreen",
  "home.gather": "Gather",
  "home.memoriesSlideshow": "Memories slideshow",
  "home.searchMemories": "Search memories",
  "home.whereWeGather": "Where we gather",
  "home.festivalChapters": "Festival Chapters",
  "home.villageLife": "Village life",
  "home.annualTraditions": "Annual traditions",
  "home.festivalCalendar": "Festival calendar",
  "home.nextUp": "Next up",
  "home.viewChapter": "View chapter",
  "home.fullTimeline": "Full timeline",
  "home.historyTimeline": "History timeline",
  "home.ourStory": "Our story",
  "home.viewMore": "View more",
  "home.villageHistoryTimeline": "Village history timeline",
  "home.allBirthdays": "All birthdays",
  "home.celebratingOurOwn": "Celebrating our own — with love from the village.",
  "home.happyBirthday": "Happy Birthday!",
  "home.todaysBirthday": "Today's Birthday",
  "home.birthdaysEmpty": "Birthday dates will appear here as they are added for each member.",
  "home.nextCelebrations": "Next celebrations in our community.",
  "home.photoSoon": "Photo Coming Soon",
  ...
  "person.adapaduchuDeceased": "Adapaduchu (Married, Deceased)",
  "person.needsVerification": "Needs Verification",
  "person.infoNotProvided": "Information not yet provided",
  "person.verified": "Verified",
  "person.nameNotAvailable": "Name Not Available",
  "person.family": "Family",
  "person.generation": "Generation",
  "person.status": "Status",
  "person.occupation": "Occupation",
  "person.location": "Location",
  "person.connection": "Reddivaripalli Connection",
  "person.verification": "Verification Status",
  "person.parents": "Parents",
  "person.spouse": "Spouse",
  "person.children": "Children",
  "person.viewTree": "View family tree",
  "person.openProfile": "Open profile",
  "person.memberOfParental": "Member of the original parental family",
  "person.memberOf": "Member of {branch}",
  "tree.zoomIn": "Zoom in",
  "tree.zoomOut": "Zoom out",
  "tree.fit": "Fit to screen",
  "tree.villageFamilies": "Village Families",
  "tree.separateNote": "This page holds {count} separate families that share a surname. They are shown as {count} independent trees and are never joined — two people appear in the same tree only where a recorded parent, child or marriage connects them.",
  "tree.branchSize": "{people} people · {generations} generations",
  "tree.branchSizeOne": "{people} people · 1 generation",
  "tree.notYetPublished": "This person was added recently. Their full profile page appears after the site's next update.",
  "tree.empty": "Information not yet provided",
  "adapaduchulu.title": "Adapaduchulu",
  "adapaduchulu.lede": "Married daughters of Reddivaripalli families. Each remains a member of her original parental family. Marriage adds another connection; it does not erase the first.",
  "adapaduchulu.viewFamily": "View Family",
  "people.rosterCount": "{count} people in the member directory",
  "people.rosterCountOne": "1 person in the member directory",
  "people.treeCount": "{count} people recorded in the family trees",
  "people.adapaduchuCount": "{count} Adapaduchulu",
  "people.countsNote": "Counts come from the current records, not a fixed number.",
  "people.groupLegacy": "Our Elders",
  "people.groupCore": "Our Village Contributors",
  "people.groupNextgen": "Our Families",
