...
const HREF_ALIASES: Record<string, MessageId> = {
  "/": "nav.home",
  "/members/": "nav.people",
  "/about/": "nav.ourVillage",
  "/events/": "nav.eventsShort",
  ...
  "/terms/": "nav.terms",
  "/years/": "nav.years",
  "/services/": "nav.villageServices",
  "/dharma/": "dharma.title",
  "/telugu-culture/": "culture.title",
  "/spiritual-heritage/": "spiritual.title",
  "/government/": "nav.government",
  "/emergency/": "nav.emergencyInfo",
  "more-menu": "nav.more",
